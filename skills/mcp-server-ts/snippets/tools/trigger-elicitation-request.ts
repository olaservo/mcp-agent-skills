/**
 * Source: https://github.com/modelcontextprotocol/servers/blob/main/src/everything/tools/trigger-elicitation-request.ts
 *
 * Demonstrates standalone elicitation requests from a tool.
 * Elicitation allows servers to request user input via a schema-driven form.
