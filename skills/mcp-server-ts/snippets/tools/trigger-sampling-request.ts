/**
 * Source: https://github.com/modelcontextprotocol/servers/blob/main/src/everything/tools/trigger-sampling-request.ts
 *
 * Demonstrates simple one-shot sampling requests from a tool.
 * This is a simpler pattern than the agentic sampling loop - it sends a single
 * sampling request to the client and returns the result.
 * This tool checks client capabilities before registering.
 */
