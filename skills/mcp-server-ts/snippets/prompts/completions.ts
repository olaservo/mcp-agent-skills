/**
 * Source: https://github.com/modelcontextprotocol/servers/blob/main/src/everything/prompts/completions.ts
 *
 * Demonstrates context-aware argument completions using the `completable()` helper.
 * The second argument's completion options depend on the value of the first argument.
 */
import { z } from "zod";
